...
export default function CertModal({ type, onClose }) {
    ...
    return (
        <div className='fixed inset-0 bg-black bg-opacity-50 flex items-start justify-center z-50 p-4 pt-8 overflow-y-auto'>
            <div
                className='bg-white rounded-2xl max-w-md w-full my-4 flex flex-col shadow-2xl overflow-hidden'
            ...
            >
                ...
                >
                    ...
                    <label
                        className={`
                            block w-full rounded-xl p-6 text-center cursor-pointer transition-all flex-shrink-0
                            ${
                                isProcessing
