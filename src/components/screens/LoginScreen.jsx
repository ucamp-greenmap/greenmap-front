...
export default function LoginScreen() {
    ...
    const Google_URI = 'http://localhost:3000';
    ...
    return (
        ...
        <br/>
        <div>
            이메일: <input type="email" id="email" ></input><br/><br/>
        </div>
        <div>
        ...
        <nav>
            ...
            <NavLink to="/register"><button>회원가입</button></NavLink><br /> <br /> 
            <NavLink to="/"><button onClick={handleGoogleLogin}>구글 로그인</button></NavLink><br />
